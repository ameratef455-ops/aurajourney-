      ...
      <div className="flex flex-col gap-4 pb-10">
        <TabView className="custom-wizard-tabs">
          ...
          <TabPanel header="🛠️ مهام تطبيقية">
            <div
              className="flex flex-col gap-6 bg-emerald-50/10 p-6 rounded-3xl border border-emerald-100/30 mt-4 text-right font-sans"
              dir="rtl"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-emerald-600 font-bold">
                    إضافة وإدارة المهام التطبيقية للمحطة
                  </p>
                </div>
                <button
                  onClick={() => openTaskModal(selectedStation, "practical")}
                  className="w-10 h-10 rounded-xl bg-emerald-600 text-white flex items-center justify-center border-none shadow-md hover:bg-emerald-700 transition-all cursor-pointer"
                >
                  <Plus size={20} />
                </button>
              </div>
              <div className="space-y-3">
                {practicalTasks.map((t: any) => {
                  ...
                  return (
                    <div
                      key={t.id}
                      className="bg-white p-5 rounded-2xl border border-emerald-100 shadow-3xs flex items-center justify-between group"
                    >
                      <div
                        onClick={() =>
                          openTaskModal(
